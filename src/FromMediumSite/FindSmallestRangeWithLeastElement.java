...
public class FindSmallestRangeWithLeastElement implements  Comparable {
    ...
    // A class for heap node
        ...
        FindSmallestRangeWithLeastElement(int value, int listNum, int index) {
            this.value = value;
        ...
        public int compareTo(Object o) {
            FindSmallestRangeWithLeastElement node = (FindSmallestRangeWithLeastElement)o;
    ...
    class MinimumRange
    {
        ...
        public static Pair findMinimumRange(List<List<Integer>> list)
        {
            ...
            PriorityQueue<FindSmallestRangeWithLeastElement> pq = new PriorityQueue<>();

            // push first element of each list into the min-heap
            // along with list number and their index in the list
            for (int i = 0; i < list.size(); i++)
            {
                pq.add(new FindSmallestRangeWithLeastElement(list.get(i).get(0), i, 0));
            ...
            {
                // remove root node
                FindSmallestRangeWithLeastElement top = pq.poll();
                ...
                pq.add(new FindSmallestRangeWithLeastElement(list.get(i).get(j + 1), i, j + 1));
